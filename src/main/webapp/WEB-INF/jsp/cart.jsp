...
<c:forEach var="item" items="${cart.goodsList}">
        <div class="cart-header col-md-6  item${item.goodId}" id="item">
            <div class="cart-sec simpleCart_shelfItem">
                ...
                <div class="cart-item-info">
                    ...
                    <h3><span class="cart_item_num${item.goodId}">数量: ${item.goodsNum}</span></h3>
                    <a class="btn btn-info" href="#" onclick="addGoodNum(${item.goodId})">增加</a>
                    <a class="btn btn-warning"  href="#" onclick="decGoodNum(${item.goodId})">减少</a>
                    <a class="btn btn-danger"   href="#" onclick="deleteGood(${item.goodId})">删除</a>
                </div>
