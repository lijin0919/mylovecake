            ...
            success: function (respons) {
                ...
                for (var i = 0; i < respons.goodsList.length; i++) {
                    htmldiv +=
                        ...
                        "                                    </div>\n" +
                        "                                    <div class=\"minicart_div_center_div\">\n" +
                        "                                        <input class=\"min\" name=\"\" type=\"button\" value=\"-\" id=\"btn-warning\" onclick='decGoods(" + respons.goodsList[i].goodId + ")'/>\n" +
                        "                                        <input class=\"text_box\" name=\"goodnum\" type=\"text\" value=\"" + respons.goodsList[i].goodsNum + "\" style=\"width:25px;\" id=\"cart_item_num6\"/>\n" +
                        "                                        <input class=\"add\" name=\"\"  type=\"button\" value=\"+\" id=\"btn-info\" onclick='addGoods(" + respons.goodsList[i].goodId + ")' />\n" +
                        "                                    </div>\n" +
                        "                                </div>\n" +
                        "                                <!--右，删除按钮-->\n" +
                        "                                <div class=\"minicart_div_right\">\n" +
                        "                                    <div class=\"minicart_div_center_div\"></div>\n" +
                        "                                    <div class=\"minicart_div_center_div\"><button id=\"btn-danger6\" onclick='deleteGoods(" + respons.goodsList[i].goodId + ")' >删除</button></div>\n" +
                        "                                    <div class=\"minicart_div_center_div\"></div>\n" +
                        "                                </div>\n" +
                        "\n" +
                        "                            </div>"
            ...
            success: function (respons) {
                ...
                for (var i = 0; i < respons.goodsList.length; i++) {
                    htmldiv +=
                        ...
                        "                                    </div>\n" +
                        "                                    <div class=\"minicart_div_center_div\">\n" +
                        "                                        <input class=\"min\" name=\"\" type=\"button\" value=\"-\" id=\"btn-warning\" onclick='decGoods(" + respons.goodsList[i].goodsNum + ")'/>\n" +
                        "                                        <input class=\"text_box\" name=\"goodnum\" type=\"text\" value=\"" + respons.goodsList[i].goodsNum + "\" style=\"width:25px;\" id=\"cart_item_num6\"/>\n" +
                        "                                        <input class=\"add\" name=\"\"  type=\"button\" value=\"+\" id=\"btn-info\" onclick='addGoods(" + respons.goodsList[i].goodsNum + ")' />\n" +
                        "                                    </div>\n" +
                        "                                </div>\n" +
                        "                                <!--右，删除按钮-->\n" +
                        "                                <div class=\"minicart_div_right\">\n" +
                        "                                    <div class=\"minicart_div_center_div\"></div>\n" +
                        "                                    <div class=\"minicart_div_center_div\"><button id=\"btn-danger6\" onclick='deleteGoods(" + respons.goodsList[i].goodsNum + ")' >删除</button></div>\n" +
                        "                                    <div class=\"minicart_div_center_div\"></div>\n" +
                        "                                </div>\n" +
                        "\n" +
                        "                            </div>"
